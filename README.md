...
| 9 | 3 | 520 nm 绿灯 PWM 输出 | 5（GPIO3/SCL1） | 6（GND） | - | - | - |
| 7 | 4 | 450 nm 蓝灯 PWM 输出 | 7（GPIO4） | 8（GPIO14/TXD） | EMM TXD -> 驱动 RX | 14 | 15 |
...
- BCM2/3（物理 3/5）是 I2C1 SDA1/SCL1 且通常带上拉，当前分别用于
  400 nm 紫外灯和 520 nm 绿灯 PWM；使用这两路时不能同时启用 I2C1。
- BCM4（物理 7）当前用于 450 nm 蓝灯 PWM。
